...
mongodb_collection = mongodb["rhino"]
logger = logging.getLogger()


class Rhino(scrapy.Spider):
    name = "Rhino_MozillaBugzilla"
    start_urls = [
        'https://bugzilla.mozilla.org/rest/bug?product=rhino&status=RESOLVED&status=VERIFIED&status=CLOSED',
    ]
